 ...
 */
public record DefaultSingleObjectiveFitness(
        double score, Goal goal
     ...
     */
    public static DefaultSingleObjectiveFitness of(double score, Goal goal) {
        return new DefaultSingleObjectiveFitness(score, goal);
    }
     ...
     */
    public DefaultSingleObjectiveFitness map(final Function<Double, Double> mapper) {
        return DefaultSingleObjectiveFitness.of(mapper.apply(this.score()), this.goal());
    }
}
