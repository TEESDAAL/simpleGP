...
/**
 * The interface for a six tree multi-tree GP individual.
 ...
 */
public interface SixTreeIndividual<
    T1, R1,
    T2, R2,
    T3, R3,
    T4, R4,
    T5, R5,
    T6, R6,
    Self extends SixTreeIndividual<T1, R1, T2, R2, T3, R3, T4, R4, T5, R5, T6, R6, Self>
    > extends MultiTree<
    T1, R1,
    MultiTree<T2, R2,
        MultiTree<T3, R3,
            ...
            ?>,
        ?>,
    SixTreeIndividual<T1, R1, T2, R2, T3, R3, T4, R4, T5, R5, T6, R6, Self>
    > {
