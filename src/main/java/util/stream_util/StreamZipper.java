    ...
    private static <A, B, R> Spliterator<R> spliterator(
        ...
        return new Spliterator<>() {
            ...
            public boolean tryAdvance(Consumer<? super R> action) {
                final Mutable<A> aBox = Mutable.of(null);
                final Mutable<B> bBox = Mutable.of(null);
                final boolean aHasNext = a.tryAdvance(aBox::set);
                final boolean bHasNext = b.tryAdvance(bBox::set);
