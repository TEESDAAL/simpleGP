    ...
    TriFunction<A, B, C, R>
{
    static <A, B, C, R> TypedTriFunction<A, B, C, R> of(
        ...
        return new TypedTriFunctionImpl<>(f, leftType, middleType, rightType, returnType);
    }
    ...
    default TypedTriFunction<A, B, C, R> cached() {
        ...
        return new TypedTriFunctionImpl<>(
            (a, b, c) -> cache.computeIfAbsent(Triple.of(a, b, c), p -> p.reduce(this)),
            leftType(),
            middleType(),
            rightType(),
            returnType()
...
record TypedTriFunctionImpl<A, B, C, R>(
    ...
    TypedTriFunctionImpl {
        Preconditions.allNonNull(f, leftType, middleType, rightType, returnType);
    }
    @Override
