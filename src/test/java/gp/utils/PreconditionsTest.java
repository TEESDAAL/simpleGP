...
public class PreconditionsTest {
    ...
    @Test
    public void testAssertFalseWithComplexCondition() {
        int x = 5;
        int y = 10;
        Preconditions.assertFalse(x > y, "x should not be greater than y");
    }

    @Test
    public void testAssertFalseWithComplexConditionFailing() {
        int x = 10;
        int y = 5;
        assertThrows(IllegalArgumentException.class,
                () -> Preconditions.assertFalse(x > y, "x should not be greater than y"));
